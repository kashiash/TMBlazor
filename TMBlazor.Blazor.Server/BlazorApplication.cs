...
using TMBlazor.Blazor.Server.Services;

namespace TMBlazor.Blazor.Server {
    public partial class TMBlazorBlazorApplication : BlazorApplication {
        public TMBlazorBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void TMBlazorBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
